  ...
  <footer className="footer">
    <div className="container">
      ...
      <div className="socials">
        <a href="https://www.reddit.com/r/POA/" target="_blank" className="socials-item" rel="noopener noreferrer"><i className="socials-i socials-i_reddit" /></a>
        ...
        <a href="https://poa.net" target="_blank" className="socials-item" rel="noopener noreferrer"><i className="socials-i socials-i_oracles" /></a>
